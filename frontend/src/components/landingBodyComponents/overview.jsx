                ...
                <div>
                    ...
                    <Container fluid style={{ marginTop: '3vh' }}>
                        ...
                        <div className="benefits-div">
                            <h2>Benefits</h2>
                            <p>
                                Wasselni gives you access to cars 24/7 without the hassle of owning one.
                                You can take a ride anytime with fuel, insurance and Roadside assistance included.
                            </p>
                            <Row>
                                <Col>
                    ...
                    <div className="find-nearest-car-div">
                        <h2>Find your nearest Wasselni Driver</h2>
                        <p>Our cars are spread all over Tunisia. There's probably one near you</p>
                        <div>
